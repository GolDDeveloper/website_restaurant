...
$sql = "SELECT bestellungen.id,speisentabelle.speise,bestellungen.Anzahl,bestellungen.tisch FROM bestellungen,speisentabelle WHERE bestellungen.speise =speisentabelle.ID  ORDER BY tisch ";
